...
func (fake *FakeExpenseService) CreateExpense(arg1 int64, arg2 *models.UserExpense) (int64, error) {
...
func (fake *FakeExpenseService) CreateExpenseCalls(stub func(int64, *models.UserExpense) (int64, error)) {
	fake.createExpenseMutex.Lock()
	defer fake.createExpenseMutex.Unlock()
	fake.CreateExpenseStub = stub
}

func (fake *FakeExpenseService) CreateExpenseArgsForCall(i int) (int64, *models.UserExpense) {
	fake.createExpenseMutex.RLock()
	defer fake.createExpenseMutex.RUnlock()
...
func (fake *FakeExpenseService) GetExpenses(arg1 int64) ([]models.UserExpense, error) {
...
func (fake *FakeExpenseService) GetExpensesCalls(stub func(int64) ([]models.UserExpense, error)) {
	fake.getExpensesMutex.Lock()
...
func (fake *FakeExpenseService) GetExpensesReturns(result1 []models.UserExpense, result2 error) {
	fake.getExpensesMutex.Lock()
	defer fake.getExpensesMutex.Unlock()
...
func (fake *FakeExpenseService) GetExpensesReturnsOnCall(i int, result1 []models.UserExpense, result2 error) {
	fake.getExpensesMutex.Lock()
	defer fake.getExpensesMutex.Unlock()
	fake.GetExpensesStub = nil
...
func (fake *FakeExpenseService) UpdateExpense(arg1 int64, arg2 int64, arg3 *models.UserExpense) (int64, error) {
...
func (fake *FakeExpenseService) UpdateExpenseCalls(stub func(int64, int64, *models.UserExpense) (int64, error)) {
	fake.updateExpenseMutex.Lock()
	defer fake.updateExpenseMutex.Unlock()
	fake.UpdateExpenseStub = stub
}

func (fake *FakeExpenseService) UpdateExpenseArgsForCall(i int) (int64, int64, *models.UserExpense) {
	fake.updateExpenseMutex.RLock()
	defer fake.updateExpenseMutex.RUnlock()
