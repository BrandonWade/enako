...
func (fake *FakeTypeService) GetTypes() ([]models.ExpenseType, error) {
...
func (fake *FakeTypeService) GetTypesCallCount() int {
	fake.getTypesMutex.RLock()
	defer fake.getTypesMutex.RUnlock()
	return len(fake.getTypesArgsForCall)
}

func (fake *FakeTypeService) GetTypesCalls(stub func() ([]models.ExpenseType, error)) {
	fake.getTypesMutex.Lock()
	defer fake.getTypesMutex.Unlock()
	fake.GetTypesStub = stub
}

func (fake *FakeTypeService) GetTypesReturns(result1 []models.ExpenseType, result2 error) {
	fake.getTypesMutex.Lock()
	defer fake.getTypesMutex.Unlock()
...
func (fake *FakeTypeService) GetTypesReturnsOnCall(i int, result1 []models.ExpenseType, result2 error) {
	fake.getTypesMutex.Lock()
	defer fake.getTypesMutex.Unlock()
	fake.GetTypesStub = nil
...
func (fake *FakeTypeService) Invocations() map[string][][]interface{} {
...
func (fake *FakeTypeService) recordInvocation(key string, args []interface{}) {
...
var _ services.TypeService = new(FakeTypeService)
